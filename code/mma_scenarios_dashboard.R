    ...
    <div class="card" style="display:flex;align-items:flex-start">
      <div style="width:100%;padding-top:2px">
        ...
        <p style="font-size:10.5px;color:var(--mut);line-height:1.8;margin:0 0 10px">
          ...
          distribuído por 21 setores IO. O vetor de pesos <b style="color:var(--txt)">ALOC_INV</b> é fixo
          (não varia por ano) — só o montante total muda entre períodos. Os pesos refletem
        ...
        <table style="width:100%;font-size:10.5px;border-collapse:collapse;margin-bottom:10px">
          ...
          <tbody>
            ...
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              ...
              <td style="padding:3px 6px;color:var(--mut)">S27 · S36 · S37</td>
              <td style="padding:3px 6px;color:#9B59B6;font-weight:700;text-align:right">19.4%</td>
              <td style="padding:3px 6px;color:var(--mut)">Borracha/plástico, peças automotivas e equipamentos de transporte (VEs, turbinas)</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
