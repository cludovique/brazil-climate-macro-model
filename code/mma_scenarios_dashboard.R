  ...
  <div class="g2" style="margin-bottom:16px">
    ...
    <div class="card" style="display:flex;align-items:flex-start">
      <div style="width:100%;padding-top:2px">
        <div class="ct">Engine 1b — Vetor de Alocação FBCF por Tema de Investimento</div>
        <p style="font-size:10.5px;color:var(--mut);line-height:1.8;margin:0 0 10px">
          O investimento total do MMA (R$ bi/ano por período, via CAE) é convertido num choque de demanda final
          distribuído por setores IO. O vetor de pesos <b style="color:var(--txt)">ALOC_INV</b> varia por ano
          e por política: o conteúdo doméstico de equipamentos importados (turbinas, painéis, baterias) cresce
          de 2026 a 2050 sob a <b style="color:#3BD6F5">Política de Localização Industrial</b>
          (40%→70% turbinas · 20%→55% painéis · 30%→65% baterias). Os pesos refletem
          <b style="color:var(--txt)">onde o capital de transição é efetivamente gasto</b>: equipamentos,
          obras, insumos e capacitação.
        </p>

        <!-- Allocation groups table -->
        <table style="width:100%;font-size:10.5px;border-collapse:collapse;margin-bottom:10px">
          <thead><tr>
            <th style="color:var(--mut);font-weight:500;padding:3px 6px;border-bottom:1px solid var(--bdr);text-align:left">Tema de investimento</th>
            <th style="color:var(--mut);font-weight:500;padding:3px 6px;border-bottom:1px solid var(--bdr);text-align:left">Setores IO</th>
            <th style="color:var(--mut);font-weight:500;padding:3px 6px;border-bottom:1px solid var(--bdr);text-align:right">Peso</th>
            <th style="color:var(--mut);font-weight:500;padding:3px 6px;border-bottom:1px solid var(--bdr);text-align:left">Rationale</th>
          </tr></thead>
          <tbody>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#F1C40F;font-weight:600">Energia elétrica</td>
              <td style="padding:3px 6px;color:var(--mut)">S40 · S41 · S42</td>
              <td style="padding:3px 6px;color:#F1C40F;font-weight:700;text-align:right">22.3%</td>
              <td style="padding:3px 6px;color:var(--mut)">Geração centralizada, distribuída e transmissão — backbone da descarbonização</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#11B2C6;font-weight:600">Infraestrutura urbana</td>
              <td style="padding:3px 6px;color:var(--mut)">S44 · S45</td>
              <td style="padding:3px 6px;color:#11B2C6;font-weight:700;text-align:right">15.5%</td>
              <td style="padding:3px 6px;color:var(--mut)">Saneamento, gestão de resíduos e obras civis (eólica, solar, linhas)</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#9B59B6;font-weight:600">Componentes &amp; Equip.</td>
              <td style="padding:3px 6px;color:var(--mut)">S27 · S34 · S36</td>
              <td style="padding:3px 6px;color:#9B59B6;font-weight:700;text-align:right">19.4%</td>
              <td style="padding:3px 6px;color:var(--mut)">Borracha/plástico, peças automotivas e máq. e equip. mecânicos (VEs, turbinas)</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#1D9E75;font-weight:600">Biocombustíveis</td>
              <td style="padding:3px 6px;color:var(--mut)">S22 · S20</td>
              <td style="padding:3px 6px;color:#1D9E75;font-weight:700;text-align:right">11.7%</td>
              <td style="padding:3px 6px;color:var(--mut)">Plantas de biocombustíveis avançados (SAF, HVO, etanol+CCS)</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#E24B4A;font-weight:600">Petróleo &amp; Gás</td>
              <td style="padding:3px 6px;color:var(--mut)">S05 · S43</td>
              <td style="padding:3px 6px;color:#E24B4A;font-weight:700;text-align:right">7.8%</td>
              <td style="padding:3px 6px;color:var(--mut)">CCS em refino (S05) e expansão de biometano/gás (S43)</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#95A5A6;font-weight:600">Ind. pesada</td>
              <td style="padding:3px 6px;color:var(--mut)">S29 · S28 · S04</td>
              <td style="padding:3px 6px;color:#95A5A6;font-weight:700;text-align:right">7.8%</td>
              <td style="padding:3px 6px;color:var(--mut)">Aço e cimento verdes para infraestrutura; minerais críticos para baterias</td>
            </tr>
            <tr style="border-bottom:1px solid rgba(255,255,255,.04)">
              <td style="padding:3px 6px;color:#6B8E23;font-weight:600">Agropecuária</td>
              <td style="padding:3px 6px;color:var(--mut)">S01 · S08</td>
              <td style="padding:3px 6px;color:#6B8E23;font-weight:700;text-align:right">5.8%</td>
              <td style="padding:3px 6px;color:var(--mut)">Expansão de culturas energéticas e cadeia de alimentos para bioeconomia</td>
            </tr>
            <tr>
              <td style="padding:3px 6px;color:var(--mut);font-weight:600">Transporte &amp; Cap. pública</td>
              <td style="padding:3px 6px;color:var(--mut)">S50 · S51 · S66 · S67</td>
              <td style="padding:3px 6px;color:var(--mut);font-weight:700;text-align:right">9.7%</td>
              <td style="padding:3px 6px;color:var(--mut)">Aviação verde, logística de baixo carbono e capacidade institucional pública</td>
            </tr>
          </tbody>
        </table>

        <p style="font-size:10px;color:var(--mut);line-height:1.7;margin:0 0 10px">
          <b style="color:var(--txt)">Mecanismo:</b>
          CAE (R$ bi/ano) × ALOC_INV[s] → Δf[s] (choque FBCF setorial) → L* · Δf → Δx (produção induzida).<br>
          <b style="color:var(--txt)">Normalização:</b> os pesos são normalizados para somar 1.0, garantindo que o total
          do investimento seja integralmente alocado — sem vazamento nem dupla contagem.<br>
          <b style="color:var(--txt)">Invariância temporal:</b> a distribuição setorial é constante entre 2020 e 2050;
          apenas o volume total (CAE por período) varia.
        </p>
        <div style="background:rgba(243,156,18,.08);border-left:3px solid #F39C12;border-radius:3px;padding:8px 10px">
          <div style="font-size:10px;font-weight:700;color:#F39C12;margin-bottom:3px">⚠ Ponto de melhoria</div>
          <p style="font-size:10px;color:var(--mut);line-height:1.7;margin:0">
            Os pesos atuais são <b style="color:var(--txt)">premissas manuais</b> baseadas em julgamento técnico —
            não foram calibrados a partir das tabelas de investimento do próprio plano MMA.
            O plano contém um detalhamento por tema/tecnologia (eólica, solar, VEs, biocombustíveis, etc.)
            que deveria ser mapeado diretamente aos setores IO via <code>Mapeamento_Setores</code> para derivar
            esses pesos de forma <b style="color:var(--txt)">data-driven</b>.
          </p>
        </div>
      </div>
    </div>
...
function renderAlocChart(aloc){
  ...
  const alocS=[...aloc]
    .filter(r=>r.cenario==="100D"&&+r.ano===S.ano&&r.localiz_policy===alocPolicy)
  ...
  mkHBar("ch-aloc",alocS.map(r=>r.cod+(r.nome?" "+String(r.nome).slice(0,18):"")),
    ...
    {plugins:{...CD.plugins,legend:{display:false},
              tooltip:{...CD.plugins.tooltip,callbacks:{label:ctx=>`R$ ${ctx.parsed.x.toFixed(2)} bi`}}},
